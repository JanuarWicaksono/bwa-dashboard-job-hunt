        ...
        <div>
                ...
                <div className="col-span-2 space-y-10">
                    <div>
                        ...
                        <div className="text-grey-500">
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime neque nihil beatae quo architecto ab assumenda repellat porro quam nobis, reiciendis sequi quas, suscipit tenetur vero sapiente ratione aut enim.
                            </p>
                        </div>
                    </div>
                    <div>
            ...
            <div>
                ...
                <div className="text-gray-500">
                    This job comes white several perks and benefits
                </div>
                ...
                <div className="grid grid-cols-4 gap-5 mt-9">
                    {[0,1,2].map((item: number) => (
                        <div key={item}>
                            ...
                            <div className="text-lg font-semibold mb-3">Full Hearlcare</div>
                            <div className="text-gray-500">
                                We belive in thriving communities and that starts with our team being happy and healthy
                            </div>
                        </div>
                    ))}
                </div>
